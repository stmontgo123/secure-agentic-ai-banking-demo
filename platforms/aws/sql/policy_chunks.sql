...
SELECT
    ...
    'INTERNAL',
    'CUSTOMER_SERVICE'
WHERE NOT EXISTS (SELECT 1 FROM policy_chunks WHERE policy_id = 'CV-04');
...
SELECT
    ...
    'INTERNAL',
    'CUSTOMER_SERVICE'
WHERE NOT EXISTS (SELECT 1 FROM policy_chunks WHERE policy_id = 'CA-12');
...
SELECT
    ...
    'RESTRICTED',
    'FRAUD_ANALYST'
WHERE NOT EXISTS (SELECT 1 FROM policy_chunks WHERE policy_id = 'FR-09');
